...
<head>
    ...
    <link rel="stylesheet" href="phpprog/css"/>
    <style type="phpprog/css"></style> 
...
<div style="text-align: center;">
    <h1>Basic Syntax for PHP Programming Language</h1>
</div>

<?php


echo "<b>Hello Everyone</b><br><br>";
echo "<i>Ready for Every Good Work<i><br><br>";
echo"<u>Primacy of God</u><br><br>";

?>
<?php
$txt = "<b><i>Core Values</i></b>";
echo "Honest " . $txt;
?>

<div class="wrapper">
  <div class="button-container">
    <a class="cta" href="PHPbasic.php">
      <span>
