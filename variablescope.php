...
echo "<b>PHP has three different variable scopes:</b><br><br>";
echo "Local<br><br>";
echo "Global<br><br>";
echo"Static<br><br>";
...
<div style="text-align: center;">
<h3>Example of Variable with Global Scope</h3>
</div>  
<?php
$x = 260; // global scope
...
<div style="text-align: center;">
<h3>Example of Variable with Local Scope</h3>
</div>  
