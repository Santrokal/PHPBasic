...
<div style="text-align: center;">
<h2>Displaying an Single Text</h2>
</div>

<?php
echo "<h2>PHP is Fun Programming!</h2>";
echo "First we need start with <b>Hello world!</b><br>";
echo "My next Line Should be <b>I'm about to learn PHP!</b><br>";
echo "Finally Displaying some text <b>This </b>", "<b>string ", "was ", "made ", "with multiple parameters.</b>";
?>
<div style="text-align: center;">
<h2>Displaying an Variables</h2>
</div>
<?php
$txt1 = "<b>Sacred Heart College (Autonomous)</b>";
$txt2 = "https://www.shctpt.edu/";

echo "<h2>$txt1</h2>";
echo "<p>Study Discipline at $txt2</p>";
?>
<div style="text-align: center;">
<h2>Using Single Quotes</h2>
</div>
<?php
$txt1 = "<b><i>Sacred Heart College (Autonomous)</b></i>";
$txt2 = "https://www.shctpt.edu/";

print '<h2>' . $txt1 . '</h2>';
print '<p>Study Discipline at ' . $txt2 . '</p>';
?>

<div class="wrapper">
  <div class="button-container">
    <a class="cta" href="variablescope.php">
      <span>
