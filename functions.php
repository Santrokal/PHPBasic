...
<p>PHP has over 1000 built-in functions that can be called directly, from within a script, to perform a specific task.</p>

<p>Please check out our PHP reference for a complete overview of the</p> 
<a href="https://www.w3schools.com/php/php_ref_overview.asp" target="_blank">PHP built-in functions.</a>
