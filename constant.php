...
<div style="text-align: center;">
    <h3>Creating PHP Constant</h3>
</div>

<p>To create a constant, use the define() function.</p>
<p>Basic Syntax</p>
<?php
echo "define(name, value, case-insensitive);"
?>

<div style="text-align: center;">
    <h3>Creating a Constant with a Case- Sensitive</h3>
</div>

<?php
define("TEXT", "Welcome to https://www.shctpt.edu/!");
echo TEXT;
?>

<?php
define("WORD", "Welcome to https://www.shctpt.edu/", true);
echo WORD;
?>

<div style="text-align: center;">
    <h3>PHP const Keyword</h3>
</div>
...
<?php
define("GREETING", "Welcome to My College!");
