...
<ol><b>if<b>statement - executes some code if one condition is true</ol>
<ol><b>if...else</b> statement - executes some code if a condition is true and another code if that condition is false</ol>
<ol><b>if...elseif...else </b> - executes different codes for more than two conditions</ol>
<ol><b>switch</b> statement - selects one of many blocks of code to be executed</ol>
...
if ($t < 90) {
  echo "It's an Example of If Condition!";
}
?>
